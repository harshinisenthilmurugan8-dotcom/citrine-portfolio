...
import { ArrowUpRight, BookOpen, Star } from '@phosphor-icons/react';
...
const books = [
  {
    ...
    year: '2025',
    image: '/images/book-love-ka-jugaad.png',
    description: 'Viraaj Naraen, a quirky Chennai journalist, crashes into Aneri Khongwir, a fiery Shillong girl — at the wedding of their cousins… to each other. Rom-com chaos meets political drama in a story about courage and against-all-odds love.',
  ...
  },
  {
    ...
    year: '2025',
    image: '/images/book-nation-wants.png',
    description: 'When journalist Viraaj and political leader Aneri choose truth over comfort, they ignite a national conversation no one was ready for. A sharp, fast-paced political thriller exploring conscience and public scrutiny.',
...
export default function BooksSection() {
  return (
    <section id="books" className="relative py-32 px-6 lg:px-12 bg-wine-800/10">
      <div className="max-w-7xl mx-auto">
        <ScrollReveal>
          <div className="mb-24 text-center">
            <h2 className="text-5xl md:text-6xl font-display text-cream-100 mb-6">Published <span className="italic text-cream-300">Works</span></h2>
              ...
              <div className={`group flex flex-col ${i % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 lg:gap-24 items-center`}>
                ...
                <div className="lg:w-1/2 w-full flex justify-center">
                  ...
                  >
                    ...
                    <div className="relative rounded-sm overflow-hidden border border-wine-700/50 group-hover:border-gold-500/40 transition-colors duration-500 shadow-2xl">
                      <img src={book.image} alt={book.title} className="w-full aspect-[2/3] object-cover" />
                ...
                <div className="lg:w-1/2 w-full flex flex-col justify-center text-center lg:text-left">
                  ...
                  <div className="flex items-center gap-1 justify-center lg:justify-start mb-10">
                    {[...Array(5)].map((_, s) => (<Star key={s} size={16} weight="fill" className="text-gold-500/70" />))}
                    <span className="text-cream-300/70 font-mono uppercase tracking-widest text-[10px] ml-3">Readers' Choice</span>
                  </div>
